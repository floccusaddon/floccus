export const actions = {
  ...
  LOAD_FOLDERS_FROM_DISK: 'LOAD_FOLDERS_FROM_DISK',
  LOAD_CHILDREN: 'LOAD_CHILDREN',
  LOAD_TAGS: 'LOAD_TAGS',
  SEARCH_ITEMS: 'SEARCH_ITEMS',
  FIND_BOOKMARK_BY_URL: 'FIND_BOOKMARK_BY_URL',
  LOAD_TAG_SUPPORT: 'LOAD_TAG_SUPPORT',
  ...
  TEST_KARAKEEP_SERVER: 'TEST_KARAKEEP_SERVER',
...
export const mutations = {
  ...
  LOAD_FOLDERS: 'LOAD_FOLDERS',
  SET_TAG_SUPPORT: 'SET_TAG_SUPPORT',
